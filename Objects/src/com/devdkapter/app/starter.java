...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.devdkapter.app", "com.devdkapter.app.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.devdkapter.app.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static anywheresoftware.b4a.phone.Phone.PhoneVibrate _pv = null;
public static de.donmanfred.ShortcutBadgerwrapper _badge = null;
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Dim pv As PhoneVibrate";
_pv = new anywheresoftware.b4a.phone.Phone.PhoneVibrate();
 //BA.debugLineNum = 10;BA.debugLine="Dim badge As ShortcutBadger";
_badge = new de.donmanfred.ShortcutBadgerwrapper();
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return "";
}
public static String  _service_create() throws Exception{
 //BA.debugLineNum = 13;BA.debugLine="Sub Service_Create";
 //BA.debugLineNum = 16;BA.debugLine="CallSubDelayed(FirebaseMessaging, \"SubscribeToTop";
anywheresoftware.b4a.keywords.Common.CallSubDelayed(processBA,(Object)(mostCurrent._firebasemessaging.getObject()),"SubscribeToTopics");
 //BA.debugLineNum = 17;BA.debugLine="badge.Initialize()";
_badge.Initialize(processBA);
